    ...
    public static class PostFlopSolves
    {
        ...
        public static void Solve(SolverConnection solver, string savePath, int seconds = 90)
        {
            try
            {
                ...
                Console.WriteLine($"Manually solving tree...");
                running = true;
                ...
                Console.WriteLine("Manually solving tree completed");
                solver.LogEvent -= Solver_LogEvent;
        ...
        public static void BuildTree(SolverConnection solver,  List<Player> player, string board, decimal pot)
        {
            try
            {
                Console.WriteLine($"Manually building tree...");
                ...
                Console.WriteLine($"Manually building tree completed");
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
